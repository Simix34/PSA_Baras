...
namespace PSA_Baras.Controllers
{
    public class CocktailsController : Controller
    {
        ...
        {
            var barasDBContext = _context.Cocktail.Include(c => c.cart_item);
        ...
        {
            ViewData["cart_itemId"] = new SelectList(_context.CartItem, "Id", "Id");
            return View();
        }
        ...
        public async Task<IActionResult> Create([Bind("Id,title,price,color,proof,category,cart_itemId")] Cocktail cocktail)
        {
            ...
            ViewData["cart_itemId"] = new SelectList(_context.CartItem, "Id", "Id", cocktail.cart_itemId);
            return View(cocktail);
        }
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("Id,title,price,color,proof,category,cart_itemId")] Cocktail cocktail)
        {
            if (id != cocktail.Id)
            {
                return NotFound();
