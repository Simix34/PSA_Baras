...
namespace PSA_Baras.Migrations
{
    ...
    [Migration("20200427153012_Update")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("PSA_Baras.Models.CocktailProduct", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
            ...
            modelBuilder.Entity("PSA_Baras.Models.CocktailProduct", b =>
                {
                    b.HasOne("PSA_Baras.Models.Cocktail", "cocktail")
                        .WithMany("cocktailProducts")
                        .HasForeignKey("cocktailId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("PSA_Baras.Models.Product", "product")
                        .WithMany("cocktailProducts")
